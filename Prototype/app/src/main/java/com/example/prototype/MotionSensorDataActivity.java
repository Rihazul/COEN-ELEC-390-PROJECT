...
public class MotionSensorDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_motion_sensor_list_view);
    ...
    private void fetchMotionSensorDataFromFirebase() {
        DatabaseReference dbRef = FirebaseDatabase.getInstance().getReference("sensors/motionSensor");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Log.e(TAG, "Error fetching motion sensor data", databaseError.toException());
            }
        });
    }
